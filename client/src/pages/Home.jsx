...
import { Star, Utensils, Waves, Dumbbell, Car, Wifi, Shield, ArrowRight, Quote } from 'lucide-react';
...
const services = [
  ...
  { icon: Waves, title: 'Infinity Pool', desc: 'Rooftop pool with panoramic mountain views' },
    ...
    <div className="pt-16">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 min-h-[500px]">
        ...
        <div className="bg-navy-light flex items-center px-10 py-16 lg:px-16">
          <div>
            ...
            <Link to="/rooms" className="btn-gold inline-flex items-center gap-2">
      ...
      <section className="relative py-28 overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <Link to="/rooms" className="btn-gold inline-flex items-center gap-2 text-lg px-8 py-4">
