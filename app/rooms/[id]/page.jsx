...
export default function RoomDetail() {
  ...
  const images = room.images?.length ? room.images : ['/img/bed1.jpg'];

  return (
    <div className="pt-24 pb-20 min-h-screen">
      <div className="max-w-7xl mx-auto px-4">
        <button onClick={() => router.push('/rooms')} className="flex items-center gap-1 text-slate-400 hover:text-gold mb-6 transition-colors text-sm">
