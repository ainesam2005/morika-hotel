...
const EMPTY = { name: '', description: '', type: 'single', pricePerNight: '', capacity: '', sizeSqm: '', floor: '', amenities: '', images: '', isAvailable: true };
...
export default function AdminRoomsWrapper() {
  return (
    <AdminRoute>
      <AdminRoomsPage />
    </AdminRoute>
