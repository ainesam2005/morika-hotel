    ...
    <div className="pt-24 pb-20 min-h-screen">
      <div className="max-w-5xl mx-auto px-4">
        <div className="flex items-center justify-between gap-4 mb-10 flex-wrap">
          ...
          <Link href="/profile/edit" className="btn-outline-gold flex items-center gap-2 text-sm py-2 px-4">
        ...
        <div>
          ...
          {loading ? (
            ...
            <div className="text-center py-16 bg-navy-light rounded-2xl border border-navy-lighter">
              ...
              <Link href="/rooms" className="btn-gold">Browse Rooms</Link>
            </div>
          ) : (
            <div className="space-y-4">
              {bookings.map((b) => {
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-3 flex-wrap">
                          ...
                          {(b.status === 'pending' || b.status === 'confirmed') && cancellingId !== b._id && (
                            <button onClick={() => setCancellingId(b._id)} className="text-xs text-red-400 hover:text-red-300 transition-colors">
                              Cancel
                            </button>
                          )}
                          {cancellingId === b._id && (
